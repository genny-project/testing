...
ENV_FILE=$ENV_FILE docker-compose -f docker-compose.test.yml up -d
ENV_FILE=$ENV_FILE docker-compose -f docker-compose.test.yml logs -f  bridge rulesservice qwanda-service messages robot
