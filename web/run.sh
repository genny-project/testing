#!/bin/bash
PWD=`pwd`
docker run -e WEB_URL=http://v2.channel40.com.au -v $PWD/reports:/home/robot-framework-logs -v $PWD/screenshots:/home/robot-framework/screenshots rohitcs/rohit-robot
